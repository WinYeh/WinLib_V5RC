...
class Pose 
{
    public:
         ...
         * @code {.cpp}
         * // create a pose
         * genesis::Pose poseA(5, // x position
         *                    10, // y position
         *                    1.57); // heading
         * // create a pose
         * genesis::Pose poseB(5.2, 22); // x and y position, heading defaults to 0
         * @endcode
         */
         ...
         * @code {.cpp}
         * // create a pose
         * genesis::Pose poseA(5, 10, 1.57);
         * // create a pose
         * genesis::Pose poseB(5.2, 22, 2.22);
         * // add the two poses
         * genesis::Pose poseC = poseA + poseB;
         ...
         * @code {.cpp}
         * // create a pose
         * genesis::Pose pose(1, 2);
         * // multiply the pose by 4.0
         * genesis::Pose result = pose * 4.0;
         ...
         * @code {.cpp}
         * // create a pose
         * genesis::Pose pose(6, 8);
         * // divide the pose by 2
         * genesis::Pose result = pose / 2;
         ...
         *
         * @note heading is not considered in this operation
         * @note this func is used for pure pursuit 
         *
         ...
         * @code {.cpp}
         * // create poses
         * genesis::Pose poseA(0, 0);
         * genesis::Pose poseB(0, 2);
         * // find the pose in between the 2 poses
         * genesis::Pose result = poseA.lerp(poseB, 0.5);
         ...
         * @code {.cpp}
         * // create poses
         * genesis::Pose poseA(-1, -2);
         * genesis::Pose poseB(2, 1);
         ...
         * @code {.cpp}
         * // create pose
         * genesis::Pose pose(1, 0);
         * // rotate pose by pi/2
         * genesis::Pose result = pose.rotate(M_PI_2);
         * // result.x = 0, result.y = 1
         * @endcode
         */
